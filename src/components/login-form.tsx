...
import { validateLoginForm } from "@/validor/validacao";
...
export function LoginForm({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (res.isValid) {
      // Pode chamar a API / next-auth aqui
      console.log('Pronto para enviar:', { email, password });
    }
  };
        ...
        <CardHeader className="text-center pt-12 pb-">
          <CardTitle className="text-3xl font-extrabold text-gray-800 dark:text-gray-100">
            ...
            <div className="mb-12 flex justify-center">
              <img src="/ifro-events-icon.svg" alt="IFRO EVENTS" className="w-3000 h-45" />
            </div>
          </CardTitle>
        </CardHeader>
        ...
        <CardContent className="p-14">
          <form className="flex flex-col gap-10" onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex flex-col gap-2 relative">
              ...
              {/* Esqueceu a senha */}
              <a href="#" className="self-end text-blue-600 dark:text-blue-400 hover:underline text-xl mt-2">
                Esqueceu a senha?
              </a>
            ...
            {/* Botão */}
            <Button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 py-7 text-3xl rounded-lg mt-10">
              Entrar
            </Button>
